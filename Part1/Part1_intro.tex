...
\begin{center}\includegraphics[width=0.95\linewidth]{graphics/tronheimMap} \end{center}
...
\begin{center}\includegraphics[width=1.1\linewidth]{graphics/nordlys3} \end{center}
\normalsize
...
\begin{center}\includegraphics[width=0.9\linewidth]{Part1_intro_files/figure-beamer/unnamed-chunk-6-1} \end{center}
...
\begin{center}\includegraphics[width=1.1\linewidth]{Part1_intro_files/figure-beamer/unnamed-chunk-12-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth]{Part1_intro_files/figure-beamer/unnamed-chunk-20-1} \end{center}
