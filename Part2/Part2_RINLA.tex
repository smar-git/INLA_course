...
\begin{center}\includegraphics[width=0.6\linewidth]{Part2_RINLA_files/figure-beamer/unnamed-chunk-24-1} \end{center}
\normalsize
\end{frame}
...
\begin{center}\includegraphics[width=0.6\linewidth]{Part2_RINLA_files/figure-beamer/unnamed-chunk-32-1} \end{center}
\normalsize
\end{frame}
...
\begin{center}\includegraphics[width=0.4\linewidth]{Part2_RINLA_files/figure-beamer/unnamed-chunk-33-1} \end{center}
\end{frame}
...
\begin{center}\includegraphics[width=0.6\linewidth]{Part2_RINLA_files/figure-beamer/unnamed-chunk-35-1} \end{center}
\end{frame}
...
\begin{center}\includegraphics[width=0.6\linewidth]{Part2_RINLA_files/figure-beamer/unnamed-chunk-41-1} \end{center}
\end{frame}
...
\begin{center}\includegraphics[width=1.1\linewidth]{Part2_RINLA_files/figure-beamer/unnamed-chunk-43-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth]{Part2_RINLA_files/figure-beamer/unnamed-chunk-46-1} \end{center}
\end{frame}
