...
<font size="3"> **Exercise  3:** </font> Check the model results. Are the covariate significant? what are the posterior for the range $\rho$ and the standard deviation $\sigma_u$?
...
<font size="3"> **Exercise  4:** </font> Use the function `predict()` to look at the posterior mean and standard deviation of the Gaussian field $u$. Use the function `generate()` to generate  samples from the  fitted model.
