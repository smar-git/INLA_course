...
<font size="3"> **Exercise  4:** </font> Fit the model without covariates and using all the covariates in the dataset `df`. Look at the predicted values at the station locations.
