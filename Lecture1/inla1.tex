...
\begin{center}\includegraphics[width=0.6\linewidth]{inla1_files/figure-beamer/unnamed-chunk-2-1} \end{center}
\end{frame}
...
\begin{center}\includegraphics[width=0.6\linewidth]{inla1_files/figure-beamer/unnamed-chunk-3-1} \end{center}
\end{frame}
...
\begin{center}\includegraphics[width=0.9\linewidth]{inla1_files/figure-beamer/unnamed-chunk-4-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth]{inla1_files/figure-beamer/unnamed-chunk-7-1} \end{center}
\end{frame}
...
\begin{center}\includegraphics[width=0.6\linewidth]{inla1_files/figure-beamer/unnamed-chunk-8-1} \end{center}
\end{frame}
...
\begin{center}\includegraphics[width=0.6\linewidth]{inla1_files/figure-beamer/unnamed-chunk-9-1} \end{center}
\end{frame}
...
\begin{center}\includegraphics[width=1.1\linewidth]{inla1_files/figure-beamer/unnamed-chunk-10-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth]{inla1_files/figure-beamer/unnamed-chunk-11-1} \end{center}
...
\(\pi(\bf{y}, \bf{x}|\theta)\) is also Gaussian. We have then: \[
...
\begin{center}\includegraphics[width=0.6\linewidth]{inla1_files/figure-beamer/unnamed-chunk-12-1} \end{center}
\end{frame}
...
\] so also \(\pi(x_i|\theta,\bf{y})\) is Gaussian!!\textbackslash{}
...
\begin{center}\includegraphics[width=0.6\linewidth]{inla1_files/figure-beamer/unnamed-chunk-13-1} \end{center}
\end{frame}
...
\begin{center}\includegraphics[width=0.6\linewidth]{inla1_files/figure-beamer/unnamed-chunk-14-1} \end{center}
\end{frame}
...
\begin{center}\includegraphics[width=0.6\linewidth]{inla1_files/figure-beamer/unnamed-chunk-15-1} \end{center}
\end{frame}
...
\begin{center}\includegraphics[width=0.6\linewidth]{inla1_files/figure-beamer/unnamed-chunk-16-1} \end{center}
\end{frame}
...
\begin{center}\includegraphics[width=0.6\linewidth]{inla1_files/figure-beamer/unnamed-chunk-18-1} \end{center}
